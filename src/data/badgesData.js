...
export const BADGE_POOL = [
  ...
  { id: 'b_space_suit', category: 'vehicles', name: 'うちゅうふく', emoji: '🧑‍🚀', color: '#e9ecef', desc: 'さむくて 空気のない うちゅうで、からだをまもる とくべつなふく！', image: '/assets/images/quiz/space_suit.png', detailDesc: 'マイナス150度からプラス120度におよぶ激しい温度差と極限の真空から体を保護し、純酸素の供給や体温調節を行う、一着数億円以上の生命維持装置。' },
  ...
  { id: 'b_io', category: 'satellites', name: 'イオ バッジ', emoji: '🌋', color: '#fb8500', desc: 'もくせいの まわりを まわる、かざんが いっぱいある カラフルな衛星！', image: '/assets/images/quiz/io.png', detailDesc: '木星の潮汐力による強力な摩擦熱で、400以上の活性火山が存在する太陽系で最も火山活動が激しい衛星です。' },
  { id: 'b_europa', category: 'satellites', name: 'エウロパ バッジ', emoji: '🧊', color: '#b5e2fa', desc: 'ひょうめんが こおりでおおわれ、なかに 海があるかも しれない衛星！', image: '/assets/images/quiz/europa.png', detailDesc: '分厚い氷の地殻の下に、地球の海以上の水量を誇る巨大な内部海（地下海洋）が存在し、生命が存在する可能性が高く注目されています。' },
  ...
  { id: 'b_titan', category: 'satellites', name: 'タイタン バッジ', emoji: '🌫️', color: '#ffb703', desc: 'あつい空気におおわれ、オレンジ色のガスにつつまれて、川がある衛星！', image: '/assets/images/quiz/titan.png', detailDesc: '太陽系で唯一、分厚い窒素大気と液体メタンの雨や川・湖を持つ衛星。探査機ホイヘンスが着陸に成功しました。' },
  ...
  { id: 'b_philae', category: 'satellites', name: 'フィラエ バッジ', emoji: '<ctrl42>', color: '#52b788', desc: 'ほうきぼしの ひょうめんに、はじめて 着りくした 小さなたんさ機！', detailDesc: '探査機ロゼッタから切り離され、2014年にチュリュモフ・ゲラシメンコ彗星の核へ史上初めて着陸に成功した小型着陸機。' },
  ...
  { id: 'b_akatsuki', category: 'satellites', name: 'あかつき バッジ', emoji: '🎌', color: '#ffb703', desc: 'きんせいの まわりをまわり、あつい雲のうごきをしらべる 日本の探さき！', image: '/assets/images/quiz/akatsuki.png', detailDesc: '一度軌道投入に失敗したものの5年後に見事金星周回軌道へ復活投入された感動の日本探査機。金星のスーパーローテーション（超風）を解析中。' },
  { id: 'b_kaguya', category: 'satellites', name: 'かぐや バッジ', emoji: '🎌', color: '#ffd166', desc: 'つきの ひょうめんを ハイビジョンカメラできれいにさつえいした探さき！', image: '/assets/images/quiz/kaguya.png', detailDesc: '2007年打ち上げ。NHKの超HDカメラで「満ちてくる地球（地球の出）」の撮影に成功し、月探査に世界的な金字塔を打ち立てました。' },
  ...
  { id: 'b_juno', category: 'satellites', name: 'ジュノー バッジ', emoji: '🪐', color: '#8a8a8a', desc: 'もくせいの ガスにつつまれた中を調べるために、すぐそばをまわる探さき！', image: '/assets/images/quiz/juno.png', detailDesc: '木星の強力な放射線帯に耐えるチタン製金庫室を備え、巨大な極熱オーロラや木星内部に存在する巨大な核心（コア）を解明中。' },
  { id: 'b_mir', category: 'satellites', name: 'ミール バッジ', emoji: '🚀', color: '#b5e2fa', desc: 'ロシアがつくり、むかし うちゅうひこうしさんが 長くくらした宇宙ステーション！', image: '/assets/images/quiz/mir.png', detailDesc: 'ソ連・ロシアが建設した世界初のモジュール型宇宙ステーション。15年間にわたり宇宙飛行士の長期滞在記録を次々と樹立しました。' },
  ...
  { id: 'b_black_hole', category: 'space', name: 'ブラックホール', emoji: '🕳️', color: '#8a8a8a', desc: 'ものすごい重力で、光さえも吸い込んで逃げ出せなくしてしまう宇宙の穴！', image: '/assets/images/quiz/black_hole.png', detailDesc: '超高密度に圧縮された質量によって重力が極限まで高まり、光速でも脱出できなくなる時空の領域（事象の地平線）。中心には無限密度の特異点が存在。' },
